...
| Cloud & DevOps | ![Google Cloud](https://img.shields.io/badge/Google%20Cloud-%234285F4.svg?style=for-the-badge&logo=google-cloud&logoColor=white) |
...
|-------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|
| **[Order Book](https://github.com/NikitaBryndak/order-book)**                 | High-performance, thread-safe matching engine in C++20 processing ~3M orders/sec. Implements Price/Time priority matching with optimized 'ghost order' lazy cancellation, uses threading and atomics. | `C++20` `Google Test` `CMake`                              |
