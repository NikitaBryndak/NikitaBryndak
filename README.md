...
| **[Equity Backtest](https://github.com/NikitaBryndak/equity-backtest)** | Multi-strategy equity backtesting engine with automated data ingestion, execution analytics, and performance reporting. | `Python` `pandas` `NumPy` `Matplotlib` `XGBoost` |
